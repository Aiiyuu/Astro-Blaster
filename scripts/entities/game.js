...
class Game {
    constructor(canvas, ctx) {
        ...
        this.healthPoints = config.player.health_points;
        this.isDefeated = false;
        this.gameOverSoundIsPlayed = false;
        this.canvas = canvas;
        this.ctx = ctx;
    ...
    draw() {
        ...
        if (this.backgroundLoaded) {
            ...
            const drawX = (this.canvas.width - bgWidth) / 2 + this.offsetX;
            const drawY = (this.canvas.height - bgHeight) / 2 + this.offsetY;
            // Draw the background image onto the canvas at the calculated position
            this.ctx.drawImage(this.backgroundImage, 0, 0, this.backgroundImage.width, this.backgroundImage.height, drawX, drawY, bgWidth, bgHeight);
        }
        else {
    ...
    drawHealthBar() {
        ...
        const healthPercentage = this.healthPoints / config.player.health_points;
        // Background bar
