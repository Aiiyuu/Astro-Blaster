...
const spreadMargin = config.player.projectile.spreadMargin;
/**
 ...
 */
function shootProjectileAtAngle(margin, playerRotation, playerPosition, ctx, projectiles) {
...
export default function handleShooting({ player, projectiles, ctx }) {
    ...
    if (isKeyPressed('Space') && now - lastShotTime >= config.player.projectile.reloadTime) {
        ...
        const playerPosition = Object.assign({}, player.getPosition());
...
//# sourceMappingURL=handleShooting.js.map
